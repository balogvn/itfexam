...
<html lang="en">
  <head>
    ...
    <title>Remove Participant - ITF Trainees</title>
    ...
    <div class="row">
      ...
      <main class="col-md-4 mx-auto">
        <div class="h-100 p-5 text-white bg-danger rounded-3">
          ...
          <p>Are you sure you want to remove this participant from this course?</p>
		  <form>
			<button type="submit" class="btn btn-outline-dark" type="button">YES</button>
			<a href="participants.php" class="btn btn-outline-light" type="button">NO</a>
		  </form>
        </div>
      </main>
